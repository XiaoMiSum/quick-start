    ...
    <el-col :span="19" :xs="24">
      <ContentWrap>
        <el-tabs v-model="activeName" @tab-change="tabChange">
          ...
          <el-tab-pane label="长期未处理" name="LongTime" />
        </el-tabs>
        <!-- 搜索工作栏 -->
        ...
        <el-row :gutter="10">
          <el-col :span="1.5">
            <el-button plain type="primary" v-hasPermi="['quality:bug:add']" @click="handleAddCase">
      ...
      <ContentWrap>
        ...
        >
          ...
          <el-table-column align="center" label="来源" prop="source">
            <template #default="scope">
              <ones-tag :type="DICT_TYPE.QUALITY_TEST_STATUS" :value="scope.row.source" />
            </template>
          </el-table-column>
          ...
          <el-table-column align="center" fixed="right" label="操作" width="150">
            <template #default="{ row }">
              <el-tooltip
                ...
                v-if="row.status === 'New'"
              >
                <el-button circle plain type="primary" @click="handleEditCase(row.id)">
                  <Icon icon="ep:edit" />
                </el-button>
              </el-tooltip>
              ...
              <el-tooltip
                ...
                content="修复"
                placement="top"
                v-if="row.status === 'Opened' || row.status === 'Reopened'"
              >
                <el-button circle plain type="primary" @click="handleEditCase(row.id)">
                  <Icon icon="ep:edit" />
                </el-button>
              ...
              <el-tooltip
                ...
                content="关闭"
                placement="top"
                v-if="row.status === 'Fixed' || row.status === 'Rejected'"
              >
                <el-button circle plain type="primary" @click="handleEditCase(row.id)">
                  <Icon icon="ep:edit" />
                </el-button>
              ...
              <el-tooltip content="复制" placement="top" v-hasPermi="['quality:bug:add']">
                <el-button circle plain type="primary" @click="handleCopyCase(row.id)">
