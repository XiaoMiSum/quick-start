<template>
  <Dialog v-model="_visible" :title="title">
    <el-form
      ...
      label-width="100px"
    >
      <el-form-item label="产线名称" prop="title">
        <el-input
      ...
      <el-form-item label="产线总监" prop="manager">
...
const formRules = reactive({
  title: [{ required: true, message: '产线名称不能为空', trigger: 'blur' }],
  manager: [{ required: true, message: '产线名称不能为空', trigger: 'blur' }]
})
...
/** 打开弹窗 */
const open = async (type: string, users: any[], id?: string) => {
  _visible.value = true
