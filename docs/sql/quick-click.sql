...
-- 插入AI智能体状态字典类型
INSERT INTO `infra_dictionary` VALUES (12, 'AI智能体状态', 'ai_agent_status', 0, 'AI智能体状态', '1', NOW(), '1', NOW(), 0);
...
-- 插入AI智能体状态字典数据
INSERT INTO `infra_dictionary_value` VALUES (31, 'ai_agent_status', '启用', '1', 1, 'success', '', '启用', '1', NOW(), '1', NOW(), 0);
INSERT INTO `infra_dictionary_value` VALUES (32, 'ai_agent_status', '禁用', '0', 2, 'danger', '', '禁用', '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例状态字典类型
INSERT INTO `infra_dictionary` VALUES (13, 'AI生成测试用例状态', 'ai_generated_testcase_status', 0, 'AI生成测试用例状态', '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例状态字典数据
INSERT INTO `infra_dictionary_value` VALUES (33, 'ai_generated_testcase_status', '待确认', '0', 1, 'info', '', '待确认', '1', NOW(), '1', NOW(), 0);
INSERT INTO `infra_dictionary_value` VALUES (34, 'ai_generated_testcase_status', '已确认', '1', 2, 'success', '', '已确认', '1', NOW(), '1', NOW(), 0);
INSERT INTO `infra_dictionary_value` VALUES (35, 'ai_generated_testcase_status', '已拒绝', '2', 3, 'danger', '', '已拒绝', '1', NOW(), '1', NOW(), 0);
INSERT INTO `infra_dictionary_value` VALUES (36, 'ai_generated_testcase_status', '已导入', '3', 4, 'warning', '', '已导入', '1', NOW(), '1', NOW(), 0);
-- ----------------------------
...
-- 新增测试用例复用统计菜单项
INSERT INTO `sys_menu` VALUES (4186, '复用统计', 'quality:case:reuse:statistics', 2, 3, 4167, 'reuse-statistics', 'ep:connection', 'CaseReuseStatistics', 'Quality/case/reuse-statistics', 1, 1, 1, 1, 0, '超级管理员', '2025-08-30 10:00:00', '超级管理员', '2025-08-30 10:00:00');

-- 插入AI模块一级菜单
INSERT INTO `sys_menu` VALUES (4187, 'AI智能体', '', 1, 10, 0, '/ai', 'ep:cpu', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI智能体管理二级菜单
INSERT INTO `sys_menu` VALUES (4188, '智能体管理', '', 2, 1, 4187, 'agent', 'ep:management', 'AI/Agent/index', 0, 1, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI智能体管理按钮权限
INSERT INTO `sys_menu` VALUES (4189, '新增', 'ai:agent:add', 3, 1, 4188, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);
INSERT INTO `sys_menu` VALUES (4190, '修改', 'ai:agent:update', 3, 2, 4188, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);
INSERT INTO `sys_menu` VALUES (4191, '删除', 'ai:agent:remove', 3, 3, 4188, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例二级菜单
INSERT INTO `sys_menu` VALUES (4192, '测试用例', '', 2, 2, 4187, 'testcase', 'ep:document', 'AI/Testcase/index', 0, 1, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例按钮权限
INSERT INTO `sys_menu` VALUES (4193, '确认', 'ai:testcase:confirm', 3, 1, 4192, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);
INSERT INTO `sys_menu` VALUES (4194, '拒绝', 'ai:testcase:reject', 3, 2, 4192, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);
INSERT INTO `sys_menu` VALUES (4195, '编辑', 'ai:testcase:update', 3, 3, 4192, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);
INSERT INTO `sys_menu` VALUES (4196, '删除', 'ai:testcase:remove', 3, 4, 4192, '', '', '', 0, 1, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例详情页面
INSERT INTO `sys_menu` VALUES (4197, '测试用例详情', '', 2, 99, 4187, 'testcase/:id', 'ep:document', 'AI/Testcase/Detail', 0, 0, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例导入页面
INSERT INTO `sys_menu` VALUES (4198, '导入测试用例', '', 2, 99, 4187, 'testcase-import', 'ep:upload', 'AI/Testcase/Import', 0, 0, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI生成测试用例编辑页面
INSERT INTO `sys_menu` VALUES (4199, '编辑测试用例', '', 2, 99, 4187, 'testcase/edit/:id', 'ep:edit', 'AI/Testcase/Edit', 0, 0, 1, '1', NOW(), '1', NOW(), 0);

-- 插入AI模块文档页面
INSERT INTO `sys_menu` VALUES (4200, '使用文档', '', 2, 3, 4187, 'document', 'ep:document', 'AI/Document', 0, 1, 1, '1', NOW(), '1', NOW(), 0);
